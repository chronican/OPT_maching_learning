...
optimizer = SGD(model.parameters(),  kappa = 175, l = 1, project = False, FW = True, lr = 0.001, momentum = 0)
#optimizer = ADAM(model.parameters(), kappa=1000, l=1, project= False, FW=False, lr= 0.001,delta=0.0000001)
loss_tr_hist, loss_te_hist, acc_train_hist, acc_test_hist = train(train_loader, test_loader,
          model, optimizer, criterion, epochs=1000)
